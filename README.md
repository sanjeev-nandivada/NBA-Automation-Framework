...
Automation Framework built with technology stack Selenium, Core Java, Cucumber with TestNG, Maven
Overview
...
This project demonstrates **best practices for test automation engineering** â€” including Page Object Model (POM) design, BDD-driven test development, Maven-based modular builds, and advanced reporting using **Extent Reports**.

Framework Modules

| Module | Description |
|---------|--------------|
| **automation-framework** | Core reusable components â€” WebDriver factory, environment management, base classes, utilities, logging, and reporting integrations. |
